...
- mean |PMI| **area** marginal (the §4 figure): **1.382** bits
- mean |PMI| **boundary** marginal (corrected): **1.308** bits  ← quote this one
- mean |PMI| under the permutation null: **0.002** bits  *(matches the 0.004 random control of §4)*
- **premise margin: 525× the noise floor**
...
|---|---|---|---|---|
| building – road | -1.17 | -3.15 | **+1.98** **⬅** | -12.5 |
| water – agriculture | -1.96 | -0.22 | **-1.74** **⬅** | -22.3 |
| road – forest | +0.87 | -0.85 | **+1.72** **⬅** | +9.2 |
| building – forest | -1.42 | -2.78 | **+1.35** **⬅** | -16.4 |
| background – road | +1.77 | +0.43 | **+1.34** **⬅** | +18.8 |
| road – barren | +1.23 | +0.01 | **+1.22** **⬅** | +14.1 |
| barren – agriculture | -0.66 | +0.52 | **-1.18** **⬅** | -7.3 |
| background – agriculture | -0.98 | +0.08 | **-1.06** **⬅** | -10.8 |
| background – building | +1.79 | +0.82 | **+0.97** **⬅** | +19.2 |
| building – barren | -2.10 | -2.95 | **+0.85** **⬅** | -23.7 |
| background – forest | +1.00 | +0.29 | **+0.71** **⬅** | +10.7 |
| forest – agriculture | -0.65 | +0.02 | **-0.68** **⬅** | -7.3 |
| road – water | -2.31 | -2.97 | **+0.66** **⬅** | -26.0 |
| barren – forest | -0.37 | -0.96 | **+0.60** **⬅** | -4.0 |
| water – barren | -0.10 | +0.37 | **-0.47** | -1.0 ⚠️ |
| building – agriculture | -3.39 | -2.97 | **-0.42** | -37.1 |
| background – water | +0.02 | +0.37 | **-0.35** | +0.2 ⚠️ |
| building – water | -5.75 | -6.04 | **+0.29** | -63.6 |
| background – barren | -0.19 | -0.40 | **+0.21** | -2.1 ⚠️ |
| road – agriculture | -0.51 | -0.46 | **-0.05** | -5.7 |
| water – forest | -0.76 | -0.79 | **+0.03** | -8.2 |
...
|---|---|---|---|
| area (as §4.4) | **1.326** | 3.064 | **5 / 21** |
| boundary (corrected) | **0.801** | 2.444 | **7 / 21** |

*area sign flips:* `background–barren` (+0.09/-0.31), `building–road` (-2.50/+0.43), `road–agriculture` (-1.07/+0.22), `water–barren` (-1.58/+0.78), `barren–agriculture` (-2.32/+0.21)

*boundary sign flips:* `background–barren` (+0.05/-0.82), `background–agriculture` (-0.20/+0.27), `road–barren` (+0.21/-0.17), `water–barren` (-0.18/+0.46), `water–agriculture` (+0.51/-1.05), `barren–agriculture` (-0.53/+0.82), `forest–agriculture` (+0.60/-1.85)

**Reading.**

The prior stays domain-specific under the corrected marginal (7 sign flips, mean |diff| 0.80 bits). **§4.4 survives and `M_eff = λ·M_global + (1−λ)·M_image` remains a requirement.** The λ-sweep stays a mandatory ablation.
