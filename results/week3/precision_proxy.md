...
- cache: `/home/priyanshu/outputs/week3_heads/cache`  |  1669 tiles  |  calib **200**, held out **1469**  |  published τ **0.5**
- proxies measured on the **calib** tiles, using no labels
- head-separated arrays present: **yes**
...
| `sem_inst_agree` ⭐ | +0.886 | 0.033 | +0.086 | 0.919 | -0.429 | 0.419 |
| `inst_fires` | -0.086 | 0.919 | +0.257 | 0.658 | +0.657 | 0.175 |
| `head_conf_ratio` ⭐ | +0.943 | 0.017 | +0.257 | 0.658 | -0.486 | 0.356 |
...
| `sem_inst_agree` | -0.010 | 47.22 | **+0.06** | +4% |
| `inst_fires` | +0.020 | 47.19 | **+0.02** | +2% |
| `head_conf_ratio` | +0.010 | 47.10 | **-0.06** | -5% |
