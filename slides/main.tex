...
% --- house colours, matching the department template ---------------------
...
\begin{frame}{\textsc{1. Introduction --- the task}}
...
\begin{frame}{\textsc{1. Introduction --- the contribution in one sentence}}
\begin{block}{}
...
\begin{frame}{\textsc{2. Motivation --- the baseline throws land cover away}}
\begin{columns}[T]
...
\begin{frame}{\textsc{2. Applications --- why a cheap correction matters}}
\begin{columns}[T]
...
\begin{frame}{\textsc{2. Applications --- one scene, two vocabularies}}
\begin{center}
...
\begin{frame}{\textsc{3. Why per-class $\tau$ is the \emph{complete}} family --- and $w$ is not}
...
\begin{frame}{\textsc{4. Literature survey --- the lineage (1/2)}}
\scriptsize
...
\begin{frame}{\textsc{4. Literature survey --- direct competitors and tools (2/2)}}
\scriptsize
\begin{tabular}{@{}p{2.5cm}p{2.0cm}p{8.4cm}@{}}
\toprule
\textbf{Work} & \textbf{Venue} & \textbf{Contribution / relevance} \\
...
\begin{frame}{\textsc{7. Results --- both levers, five-fold}}
\begin{center}\small
\begin{tabular}{lcccc}
\toprule
...
\begin{frame}{\textsc{7. Results --- the method, visually}}
\begin{center}
...
\begin{frame}{\textsc{7. Results --- what cannot be done without labels}}
\begin{columns}[T]
