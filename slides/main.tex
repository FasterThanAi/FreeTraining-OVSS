...
\includegraphics[width=\linewidth,trim=0 {.50\height} 0 0,clip]{fig9_vocabulary.pdf}\\
\footnotesize Indian UAV imagery, \indGSD{}. Same weights, two class lists typed
at inference. \bad{No ground truth exists here} --- shares, not accuracy.
\end{column}
\end{columns}
\end{frame}
